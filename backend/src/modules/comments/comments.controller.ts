...
export class CommentsController {
  ...
  @Get(":id")
  findOne(@Param("id") id: string) { return this.commentsService.findOne(id); }

  @Post()
  create(@Body() dto: CreateCommentDto) { return this.commentsService.create(dto); }

  @Patch(":id")
  update(@Param("id") id: string, @Body() dto: UpdateCommentDto) { return this.commentsService.update(id, dto); }
